...
export default class ChangeNowAggregator extends Base {
    ...
    async getQuotes(params) {
        ...
        let toCurrency = params.toToken.symbol.toLowerCase() === "pol"
            ? "matic"
            : params.toToken.symbol.toLowerCase();
        let fromNetwork = params.fromChain.name.toLowerCase() === "polygon"
            ? "matic"
            : params.fromChain.name.toLowerCase();
        let toNetwork = params.toChain.name.toLowerCase() === "polygon"
            ? "matic"
